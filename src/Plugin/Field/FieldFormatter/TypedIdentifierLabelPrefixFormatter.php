...
/**
 * Formatter that displays label: prefix + itemvalue.
 *
 * @FieldFormatter(
 *   id = "typed_identifier_label_prefix",
 *   label = @Translation("Label + Prefix"),
 *   field_types = {
 *     "typed_identifier"
 *   }
 * )
 */
class TypedIdentifierLabelPrefixFormatter extends FormatterBase {
